package com.example.juju.e_labvideoapp.utils;
...
public class DialogUHelper {
    ...
    public static void shopSingleCheckableDialog(Context context, String[] items, Integer index, DialogInterface.OnClickListener callback) {
